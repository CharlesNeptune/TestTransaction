...
public class SpringbootTestCarlosApplicationTestsEquals {
	  ...
	  /**
	    ...
	    public void testZCreate() throws ParseException {
	        ...
	        //AFTER TODAY
	        //Date toTest = new SimpleDateFormat("yyyy-MM-dd").parse(toTest+"T16:55:42.000Z");
	    ...
	    /**
	     * Aqui probamos el metodo que devuelve el estado de la transaccion
	     */
	    @Test
	    public void testGetStatus() {
	    	System.out.println("entro al status");
	    	String ref = "12345";
	     ...
	     */
	    @Test
	    public void testGetStatusD() {
	    	System.out.println("entro al statusD");
	    	String ref = "12345";
	    	String client = "ATM";
	    ...
	    public void testGetStatusE() {
	    	System.out.println("entro al statusE");
	    	String ref = "12345";
