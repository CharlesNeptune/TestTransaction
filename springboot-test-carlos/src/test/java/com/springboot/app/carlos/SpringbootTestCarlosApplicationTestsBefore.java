...
public class SpringbootTestCarlosApplicationTestsBefore {
	  ...
	  /**
	    ...
	    public void testZCreate() throws ParseException {
	        ...
	        LocalDate ldt = LocalDate.now().minusDays(300);
	    ...
	    /**
	     * Aqui probamos el metodo que nos muestra la transaccion por iban y filtro ASC DESC
	     */
		@Test
...
//					String.class);
			...
			boolean ordFilter = true;
			ResponseEntity <String> response = restTemplate.exchange(getRootUrl() + "/search/" + accountIban + "/" + ordFilter,
					HttpMethod.GET, entity, String.class);
			Assert.assertNotNull(response.getBody());    
	    }
	    
	    /**
	     * Aqui probamos el metodo que devuelve el estado de la transaccion ref no existente
	     */
	    @Test
	    public void testGetStatusA() {
	    	System.out.println("entro al statusA");
	    	String ref = "XXXXXX";
	    	String client = "CLIENT";

	        TransactionModel response = restTemplate.getForObject(getRootUrl() + "/status/"+ref+"/"+client, TransactionModel.class);
	        Assert.assertNotNull(response);
	        assertEquals("XXXXXX", response.getReference());
	        assertEquals(Status.valueOf("INVALID"),  response.getStatus());

	    }
	    /**
	     * Aqui probamos el metodo que devuelve el estado de la transaccion SETTLED ANTERIOR A hoy
	     */
	    @Test
	    public void testGetStatusB() {
	    	System.out.println("entro al statusB");
	    	String ref = "12345";
	    	String client = "CLIENT";
	        ...
	        assertEquals(Status.valueOf("SETTLED"),  response.getStatus());
	     ...
	     */
	    @Test
	    public void testGetStatusC() {
	    	System.out.println("entro al statusC");
	    	String ref = "12345";
